...
System.register("Neo/UintVariable", [], function (exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_1("UintVariable", UintVariable);
            exports_1("default", UintVariable);
        }
    };
});
System.register("Neo/Uint64", ["Neo/UintVariable", "Neo/BigInteger"], function (exports_2, context_2) {
    "use strict";
    var __moduleName = context_2 && context_2.id;
    var UintVariable_1, BigInteger_1, _max, _min, Uint64;
    return {
        setters: [
            function (UintVariable_1_1) {
                UintVariable_1 = UintVariable_1_1;
            },
        ...
        execute: function () {
            Uint64 = (function (_super) {
                ...
                Uint64.parse = function (str) {
                    var bi = BigInteger_1.default.parse(str);
                    if (bi.bitLength() > 64)
                        throw new RangeError();
                ...
                Uint64.prototype.toString = function () {
                    return (new BigInteger_1.default(this._bits.buffer)).toString();
                };
                ...
                return Uint64;
            }(UintVariable_1.default));
            exports_2("Uint64", Uint64);
            exports_2("default", Uint64);
        }
    };
});
System.register("Neo/BigInteger", ["Neo/Uint64"], function (exports_3, context_3) {
    "use strict";
    var __moduleName = context_3 && context_3.id;
    var Uint64_1, DB, DM, DV, _minusone, _one, _zero, BigInteger;
    return {
        setters: [
            function (Uint64_1_1) {
                Uint64_1 = Uint64_1_1;
        ...
        execute: function () {
            ...
            BigInteger = (function () {
                function BigInteger(value) {
                    ...
                    if (typeof value === "number") {
                        ...
                        if (parts.man.equals(Uint64_1.default.Zero) || parts.exp <= -64)
                            return;
                        if (parts.exp <= 0) {
                ...
                BigInteger.getDoubleParts = function (dbl) {
                    ...
                    var result = {
                        sign: 1 - ((uu[1] >>> 30) & 2),
                        man: new Uint64_1.default(uu[0], uu[1] & 0x000FFFFF),
                        exp: (uu[1] >>> 20) & 0x7FF,
                        fFinite: true
                    };
                    if (result.exp == 0) {
                        if (!result.man.equals(Uint64_1.default.Zero))
                            result.exp = -1074;
                    }
                        ...
                        result.man = result.man.or(new Uint64_1.default(0, 0x00100000));
                        result.exp -= 1075;
                    }
                    return result;
                };
            ...
            exports_3("BigInteger", BigInteger);
            exports_3("default", BigInteger);
        }
    };
});
System.register("Neo/Fixed8", ["Neo/Uint64", "Neo/BigInteger"], function (exports_4, context_4) {
    "use strict";
    var __moduleName = context_4 && context_4.id;
    var Uint64_2, BigInteger_2, D, _max, _minus, _min, _one, _satoshi, Fixed8;
    return {
        setters: [
            function (Uint64_2_1) {
                Uint64_2 = Uint64_2_1;
            },
            function (BigInteger_2_1) {
        ...
        execute: function () {
            ...
            Fixed8 = (function () {
                ...
                Object.defineProperty(Fixed8, "MaxValue", {
                    get: function () { return _max || (_max = new Fixed8(new Uint64_2.Uint64(0xffffffff, 0x7fffffff))); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(Fixed8, "MinusOne", {
                    get: function () { return _minus || (_minus = new Fixed8(new Uint64_2.Uint64(0xffffffff, 0xffffffff))); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(Fixed8, "MinValue", {
                    get: function () { return _min || (_min = new Fixed8(Uint64_2.Uint64.MinValue)); },
                    enumerable: true,
                    configurable: true
                });
                ...
                Object.defineProperty(Fixed8, "Satoshi", {
                    get: function () { return _satoshi || (_satoshi = new Fixed8(new Uint64_2.Uint64(1))); },
                    enumerable: true,
                    configurable: true
                });
                ...
                Fixed8.fromNumber = function (value) {
                    ...
                    if (value >= 0x8000000000000000)
                        throw new RangeError();
                    var array = new Uint32Array((new BigInteger_2.BigInteger(value)).toUint8Array(true, 8).buffer);
                    return new Fixed8(new Uint64_2.Uint64(array[0], array[1]));
                };
                ...
                Fixed8.parse = function (str) {
                    ...
                    if (digits > 8)
                        ...
                        for (var i = digits; i < 8; i++)
                            str += '0';
                    return new Fixed8(Uint64_2.Uint64.parse(str));
                };
...
System.register("Neo/Map", [], function (exports_5, context_5) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_5("NeoMap", NeoMap);
        }
    };
});
System.register("Neo/Promise", [], function (exports_6, context_6) {
    "use strict";
    var __moduleName = context_6 && context_6.id;
    var PromiseState, NeoPromise;
    return {
        setters: [],
        execute: function () {
            ...
            exports_6("NeoPromise", NeoPromise);
            exports_6("default", NeoPromise);
        }
    };
});
System.register("Neo/Uint160", ["Neo/UintVariable"], function (exports_7, context_7) {
    "use strict";
    var __moduleName = context_7 && context_7.id;
    var UintVariable_2, _zero, Uint160;
    return {
        setters: [
            function (UintVariable_2_1) {
                UintVariable_2 = UintVariable_2_1;
            }
        ],
        execute: function () {
            Uint160 = (function (_super) {
                ...
                return Uint160;
            }(UintVariable_2.default));
            exports_7("Uint160", Uint160);
        }
    };
});
System.register("Neo/Uint256", ["Neo/UintVariable"], function (exports_8, context_8) {
    "use strict";
    var __moduleName = context_8 && context_8.id;
    var UintVariable_3, _zero, Uint256;
    return {
        setters: [
            function (UintVariable_3_1) {
                UintVariable_3 = UintVariable_3_1;
            }
        ],
        execute: function () {
            Uint256 = (function (_super) {
                ...
                return Uint256;
            }(UintVariable_3.default));
            exports_8("Uint256", Uint256);
        }
    };
});
System.register("Neo/index", ["./Cryptography", "./IO", "Neo/BigInteger", "Neo/Map", "Neo/Fixed8", "Neo/Promise", "Neo/Uint160", "Neo/Uint256", "Neo/Uint64", "Neo/UintVariable"], function (exports_9, context_9) {
    "use strict";
    ...
    return {
        setters: [
            function (Cryptography_1) {
                Cryptography = Cryptography_1;
            },
            function (IO_1) {
                IO = IO_1;
            },
            function (BigInteger_3_1) {
                exportStar_1(BigInteger_3_1);
            },
            function (Map_1_1) {
                exportStar_1(Map_1_1);
            },
            function (Fixed8_1_1) {
                exportStar_1(Fixed8_1_1);
            },
            function (Promise_1_1) {
                exportStar_1(Promise_1_1);
            },
            function (Uint160_1_1) {
                exportStar_1(Uint160_1_1);
            },
            function (Uint256_1_1) {
                exportStar_1(Uint256_1_1);
            },
            function (Uint64_3_1) {
                exportStar_1(Uint64_3_1);
            },
            function (UintVariable_4_1) {
                exportStar_1(UintVariable_4_1);
            }
        ],
        execute: function () {
            exports_9("Cryptography", Cryptography);
            exports_9("IO", IO);
        }
    };
});
System.register("Neo/Cryptography/Aes", [], function (exports_10, context_10) {
    "use strict";
...
System.register("Neo/Cryptography/Base58", ["Neo/BigInteger"], function (exports_11, context_11) {
    "use strict";
    var __moduleName = context_11 && context_11.id;
    var BigInteger_4, Base58;
    return {
        setters: [
            function (BigInteger_4_1) {
                BigInteger_4 = BigInteger_4_1;
            }
        ],
        execute: function () {
            Base58 = (function () {
                ...
                Base58.decode = function (input) {
                    var bi = BigInteger_4.BigInteger.Zero;
                    for (var i = input.length - 1; i >= 0; i--) {
                        var index = Base58.Alphabet.indexOf(input[i]);
                        if (index == -1)
                            throw new RangeError();
                        bi = BigInteger_4.BigInteger.add(bi, BigInteger_4.BigInteger.multiply(BigInteger_4.BigInteger.pow(Base58.Alphabet.length, input.length - 1 - i), index));
                    }
                ...
                Base58.encode = function (input) {
                    var value = BigInteger_4.BigInteger.fromUint8Array(input, 1, false);
                    var s = "";
                    while (!value.isZero()) {
                        var r = BigInteger_4.BigInteger.divRem(value, Base58.Alphabet.length);
            ...
            exports_11("Base58", Base58);
        }
    };
});
System.register("Neo/Cryptography/ECFieldElement", ["Neo/BigInteger"], function (exports_12, context_12) {
    "use strict";
    var __moduleName = context_12 && context_12.id;
    var BigInteger_5, ECFieldElement;
    return {
        setters: [
            function (BigInteger_5_1) {
                BigInteger_5 = BigInteger_5_1;
            }
        ],
        execute: function () {
            ECFieldElement = (function () {
                function ECFieldElement(value, curve) {
                    this.value = value;
                    this.curve = curve;
                    if (BigInteger_5.BigInteger.compare(value, curve.Q) >= 0)
                ...
                ECFieldElement.fastLucasSequence = function (p, P, Q, k) {
                    ...
                    var Uh = BigInteger_5.BigInteger.One;
                    var Vl = new BigInteger_5.BigInteger(2);
                    var Vh = P;
                    var Ql = BigInteger_5.BigInteger.One;
                    var Qh = BigInteger_5.BigInteger.One;
                    for (var j = n - 1; j >= s + 1; --j) {
                        Ql = BigInteger_5.BigInteger.mod(BigInteger_5.BigInteger.multiply(Ql, Qh), p);
                        if (k.testBit(j)) {
                ...
                ECFieldElement.prototype.sqrt = function () {
                    if (this.curve.Q.testBit(1)) {
                        var z = new ECFieldElement(BigInteger_5.BigInteger.modPow(this.value, this.curve.Q.rightShift(2).add(1), this.curve.Q), this.curve);
                        return z.square().equals(this) ? z : null;
                    }
                    var qMinusOne = this.curve.Q.subtract(1);
                    var legendreExponent = qMinusOne.rightShift(1);
                    if (BigInteger_5.BigInteger.modPow(this.value, legendreExponent, this.curve.Q).equals(1))
                        return null;
                    ...
                    do {
                        var P = void 0;
                        do {
                            P = BigInteger_5.BigInteger.random(this.curve.Q.bitLength());
                        } while (P.compareTo(this.curve.Q) >= 0 || !BigInteger_5.BigInteger.modPow(P.multiply(P).subtract(fourQ), legendreExponent, this.curve.Q).equals(qMinusOne));
                    ...
                    } while (U.equals(BigInteger_5.BigInteger.One) || U.equals(qMinusOne));
                    return null;
                };
            ...
            exports_12("ECFieldElement", ECFieldElement);
            exports_12("default", ECFieldElement);
        }
    };
});
System.register("Neo/Cryptography/ECCurve", ["Neo/BigInteger", "Neo/Cryptography/ECPoint", "Neo/Cryptography/ECFieldElement"], function (exports_13, context_13) {
    "use strict";
    var __moduleName = context_13 && context_13.id;
    var BigInteger_6, ECPoint_1, ECFieldElement_1, _secp256k1, _secp256r1, ECCurve;
    return {
        setters: [
            function (BigInteger_6_1) {
                BigInteger_6 = BigInteger_6_1;
            },
            function (ECPoint_1_1) {
                ECPoint_1 = ECPoint_1_1;
            },
            function (ECFieldElement_1_1) {
                ECFieldElement_1 = ECFieldElement_1_1;
            }
        ],
        execute: function () {
            ECCurve = (function () {
                ...
                Object.defineProperty(ECCurve, "secp256k1", {
                    get: function () {
                        return _secp256k1 || (_secp256k1 = new ECCurve(BigInteger_6.BigInteger.fromString("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F", 16), BigInteger_6.BigInteger.Zero, new BigInteger_6.BigInteger(7), BigInteger_6.BigInteger.fromString("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141", 16), ("04" + "79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798" + "483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8").hexToBytes()));
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(ECCurve, "secp256r1", {
                    get: function () {
                        return _secp256r1 || (_secp256r1 = new ECCurve(BigInteger_6.BigInteger.fromString("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF", 16), BigInteger_6.BigInteger.fromString("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC", 16), BigInteger_6.BigInteger.fromString("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B", 16), BigInteger_6.BigInteger.fromString("FFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551", 16), ("04" + "6B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C296" + "4FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5").hexToBytes()));
                    },
                    enumerable: true,
                    configurable: true
                });
            ...
            exports_13("ECCurve", ECCurve);
        }
    };
});
System.register("Neo/Cryptography/ECPoint", ["Neo/BigInteger", "Neo/Cryptography/ECFieldElement"], function (exports_14, context_14) {
    "use strict";
    var __moduleName = context_14 && context_14.id;
    var BigInteger_7, ECFieldElement_2, ECPoint;
    return {
        setters: [
            function (BigInteger_7_1) {
                BigInteger_7 = BigInteger_7_1;
            },
            function (ECFieldElement_2_1) {
                ECFieldElement_2 = ECFieldElement_2_1;
            }
        ],
        execute: function () {
            ECPoint = (function () {
                        ...
                        case 0x03:
                            {
                                ...
                                var X1 = BigInteger_7.BigInteger.fromUint8Array(encoded.subarray(1), 1, false);
                        ...
                        case 0x07:
                            {
                                ...
                                var X1 = BigInteger_7.BigInteger.fromUint8Array(encoded.subarray(1, 1 + expectedLength), 1, false);
                                var Y1 = BigInteger_7.BigInteger.fromUint8Array(encoded.subarray(1 + expectedLength), 1, false);
                                p = new ECPoint(new ECFieldElement_2.ECFieldElement(X1, curve), new ECFieldElement_2.ECFieldElement(Y1, curve), curve);
                                break;
                            }
                        default:
                ...
                ECPoint.decompressPoint = function (yTilde, X1, curve) {
                    var x = new ECFieldElement_2.ECFieldElement(X1, curve);
                    ...
                    if (bit0 != yTilde) {
                        beta = new ECFieldElement_2.ECFieldElement(curve.Q.subtract(betaValue), curve);
                    }
                ...
                ECPoint.multiply = function (p, n) {
                    var k = n instanceof Uint8Array ? BigInteger_7.BigInteger.fromUint8Array(n, 1, false) : n;
                    if (p.isInfinity())
                        return p;
                    if (k.isZero())
                ...
                ECPoint.prototype.twice = function () {
                    ...
                    var TWO = new ECFieldElement_2.ECFieldElement(new BigInteger_7.BigInteger(2), this.curve);
                    var THREE = new ECFieldElement_2.ECFieldElement(new BigInteger_7.BigInteger(3), this.curve);
                ...
                ECPoint.windowNaf = function (width, k) {
                    ...
                    while (k.sign() > 0) {
                        if (!k.isEven()) {
                            var remainder = BigInteger_7.BigInteger.remainder(k, pow2wB);
                            if (remainder.testBit(width - 1)) {
                                wnaf[i] = BigInteger_7.BigInteger.subtract(remainder, pow2wB).toInt32();
                            }
                            else {
            ...
            exports_14("ECPoint", ECPoint);
            exports_14("default", ECPoint);
        }
    };
});
System.register("Neo/Cryptography/CryptoKey", [], function (exports_15, context_15) {
    "use strict";
    var __moduleName = context_15 && context_15.id;
    var CryptoKey, AesCryptoKey, ECDsaCryptoKey;
    return {
        setters: [],
        execute: function () {
            CryptoKey = (function () {
            ...
            exports_15("CryptoKey", CryptoKey);
            AesCryptoKey = (function (_super) {
            ...
            exports_15("AesCryptoKey", AesCryptoKey);
            ECDsaCryptoKey = (function (_super) {
            ...
            exports_15("ECDsaCryptoKey", ECDsaCryptoKey);
        }
    };
});
System.register("Neo/Cryptography/Sha256", [], function (exports_16, context_16) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_16("Sha256", Sha256);
        }
    };
});
System.register("Neo/Cryptography/ECDsa", ["Neo/BigInteger", "Neo/Cryptography/CryptoKey", "Neo/Cryptography/ECPoint", "Neo/Cryptography/Sha256"], function (exports_17, context_17) {
    "use strict";
    var __moduleName = context_17 && context_17.id;
    var BigInteger_8, CryptoKey_1, ECPoint_2, Sha256_1, ECDsa;
    return {
        setters: [
            function (BigInteger_8_1) {
                BigInteger_8 = BigInteger_8_1;
            },
            function (CryptoKey_1_1) {
                CryptoKey_1 = CryptoKey_1_1;
            },
            function (ECPoint_2_1) {
                ECPoint_2 = ECPoint_2_1;
            },
            function (Sha256_1_1) {
                Sha256_1 = Sha256_1_1;
            }
        ...
        execute: function () {
            ECDsa = (function () {
                ...
                ECDsa.calculateE = function (n, message) {
                    return BigInteger_8.BigInteger.fromUint8Array(new Uint8Array(Sha256_1.Sha256.computeHash(message)), 1, false);
                };
                ECDsa.generateKey = function (curve) {
                    var prikey = new Uint8Array(32);
                    window.crypto.getRandomValues(prikey);
                    var pubkey = ECPoint_2.ECPoint.multiply(curve.G, prikey);
                    return {
                ...
                ECDsa.prototype.sign = function (message) {
                    ...
                    var d = BigInteger_8.BigInteger.fromUint8Array(this.key.privateKey, 1, false);
                    var r, s;
                    do {
                        var k = void 0;
                        do {
                            do {
                                k = BigInteger_8.BigInteger.random(this.key.publicKey.curve.N.bitLength());
                            } while (k.sign() == 0 || k.compareTo(this.key.publicKey.curve.N) >= 0);
                            var p = ECPoint_2.ECPoint.multiply(this.key.publicKey.curve.G, k);
                            var x = p.x.value;
                ...
                ECDsa.sumOfTwoMultiplies = function (P, k, Q, l) {
                    ...
                    var Z = ECPoint_2.ECPoint.add(P, Q);
                    var R = P.curve.Infinity;
                    for (var i = m - 1; i >= 0; --i) {
                        R = R.twice();
                        if (k.testBit(i)) {
                            if (l.testBit(i))
                                R = ECPoint_2.ECPoint.add(R, Z);
                            else
                                R = ECPoint_2.ECPoint.add(R, P);
                        }
                        else {
                            if (l.testBit(i))
                                R = ECPoint_2.ECPoint.add(R, Q);
                        }
                    }
                    return R;
                };
                ECDsa.prototype.verify = function (message, signature) {
                    ...
                    var r = BigInteger_8.BigInteger.fromUint8Array(arr.subarray(0, 32), 1, false);
                    var s = BigInteger_8.BigInteger.fromUint8Array(arr.subarray(32, 64), 1, false);
            ...
            exports_17("ECDsa", ECDsa);
        }
    };
});
System.register("Neo/Cryptography/RIPEMD160", [], function (exports_18, context_18) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_18("RIPEMD160", RIPEMD160);
        }
    };
});
System.register("Neo/Cryptography/index", ["Neo/Cryptography/Aes", "Neo/Cryptography/Base58", "Neo/Cryptography/CryptoKey", "Neo/Cryptography/ECCurve", "Neo/Cryptography/ECDsa", "Neo/Cryptography/ECFieldElement", "Neo/Cryptography/ECPoint", "Neo/Cryptography/RIPEMD160", "Neo/Cryptography/Sha256"], function (exports_19, context_19) {
    "use strict";
    ...
    return {
        setters: [
            function (Aes_1_1) {
                exportStar_2(Aes_1_1);
            },
            function (Base58_1_1) {
                exportStar_2(Base58_1_1);
            },
            function (CryptoKey_2_1) {
                exportStar_2(CryptoKey_2_1);
            },
            function (ECCurve_1_1) {
                exportStar_2(ECCurve_1_1);
            },
            function (ECDsa_1_1) {
                exportStar_2(ECDsa_1_1);
            },
            function (ECFieldElement_3_1) {
                exportStar_2(ECFieldElement_3_1);
            },
            function (ECPoint_3_1) {
                exportStar_2(ECPoint_3_1);
            },
            function (RIPEMD160_1_1) {
                exportStar_2(RIPEMD160_1_1);
            },
            function (Sha256_2_1) {
                exportStar_2(Sha256_2_1);
            }
        ],
        execute: function () {
        }
...
System.register("Neo/IO/Stream", [], function (exports_20, context_20) {
    "use strict";
    var __moduleName = context_20 && context_20.id;
    var SeekOrigin, Stream;
    return {
        setters: [],
        execute: function () {
            (function (SeekOrigin) {
            ...
            exports_20("SeekOrigin", SeekOrigin);
            Stream = (function () {
                function Stream() {
            ...
            exports_20("Stream", Stream);
            exports_20("default", Stream);
        }
    };
});
System.register("Neo/IO/BinaryWriter", [], function (exports_21, context_21) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_21("BinaryWriter", BinaryWriter);
        }
    };
});
System.register("Neo/IO/ISerializable", [], function (exports_22, context_22) {
    "use strict";
...
System.register("Neo/IO/BinaryReader", ["Neo/Fixed8", "Neo/Uint160", "Neo/Uint256", "Neo/Uint64"], function (exports_23, context_23) {
    "use strict";
    var __moduleName = context_23 && context_23.id;
    var Fixed8_2, Uint160_2, Uint256_2, Uint64_4, BinaryReader;
    return {
        setters: [
            function (Fixed8_2_1) {
                Fixed8_2 = Fixed8_2_1;
            },
            function (Uint160_2_1) {
                Uint160_2 = Uint160_2_1;
            },
            function (Uint256_2_1) {
                Uint256_2 = Uint256_2_1;
            },
            function (Uint64_4_1) {
                Uint64_4 = Uint64_4_1;
            }
        ...
        execute: function () {
            BinaryReader = (function () {
                ...
                BinaryReader.prototype.readFixed8 = function () {
                    return new Fixed8_2.Fixed8(this.readUint64());
                };
                ...
                BinaryReader.prototype.readUint160 = function () {
                    return new Uint160_2.Uint160(this.readBytes(20));
                };
                BinaryReader.prototype.readUint256 = function () {
                    return new Uint256_2.Uint256(this.readBytes(32));
                };
                ...
                BinaryReader.prototype.readUint64 = function () {
                    ...
                    return new Uint64_4.Uint64(this.array_uint32[0], this.array_uint32[1]);
                };
            ...
            exports_23("BinaryReader", BinaryReader);
            exports_23("default", BinaryReader);
        }
    };
});
System.register("Neo/IO/MemoryStream", ["Neo/IO/Stream"], function (exports_24, context_24) {
    "use strict";
    var __moduleName = context_24 && context_24.id;
    var Stream_1, BufferSize, MemoryStream;
    return {
        setters: [
            function (Stream_1_1) {
                Stream_1 = Stream_1_1;
        ...
        execute: function () {
            ...
            exports_24("MemoryStream", MemoryStream);
        }
    };
});
System.register("Neo/IO/Helper", ["Neo/IO/BinaryReader", "Neo/IO/BinaryWriter", "Neo/IO/MemoryStream"], function (exports_25, context_25) {
    "use strict";
    var __moduleName = context_25 && context_25.id;
    var BinaryReader_1, BinaryWriter_1, MemoryStream_1;
    return {
        setters: [
            function (BinaryReader_1_1) {
                BinaryReader_1 = BinaryReader_1_1;
            },
            function (BinaryWriter_1_1) {
                BinaryWriter_1 = BinaryWriter_1_1;
            },
            function (MemoryStream_1_1) {
                MemoryStream_1 = MemoryStream_1_1;
            }
        ],
        execute: function () {
            Uint8Array.prototype.asSerializable = function (T) {
                var ms = new MemoryStream_1.MemoryStream(this.buffer, false);
                var reader = new BinaryReader_1.BinaryReader(ms);
...
System.register("Neo/IO/index", ["Neo/IO/BinaryReader", "Neo/IO/BinaryWriter", "./Caching", "Neo/IO/MemoryStream", "Neo/IO/Stream"], function (exports_26, context_26) {
    "use strict";
    ...
    return {
        setters: [
            function (BinaryReader_2_1) {
                exportStar_3(BinaryReader_2_1);
            },
            function (BinaryWriter_2_1) {
                exportStar_3(BinaryWriter_2_1);
            },
            function (Caching_1_1) {
                exportStar_3(Caching_1_1);
            },
            function (MemoryStream_2_1) {
                exportStar_3(MemoryStream_2_1);
            },
            function (Stream_2_1) {
                exportStar_3(Stream_2_1);
            }
        ],
        execute: function () {
        }
...
System.register("Neo/IO/Caching/TrackState", [], function (exports_27, context_27) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_27("TrackState", TrackState);
        }
    };
});
System.register("Neo/IO/Caching/TrackableCollection", ["Neo/IO/Caching/TrackState", "Neo/Map"], function (exports_28, context_28) {
    "use strict";
    var __moduleName = context_28 && context_28.id;
    var TrackState_1, Map_2, TrackableCollection;
    return {
        setters: [
            function (TrackState_1_1) {
                TrackState_1 = TrackState_1_1;
            },
            function (Map_2_1) {
                Map_2 = Map_2_1;
            }
        ...
        execute: function () {
            TrackableCollection = (function () {
                function TrackableCollection(items) {
                    this._map = new Map_2.NeoMap();
                    if (items != null) {
            ...
            exports_28("TrackableCollection", TrackableCollection);
        }
    };
});
System.register("Neo/IO/Caching/index", ["Neo/IO/Caching/TrackableCollection", "Neo/IO/Caching/TrackState"], function (exports_29, context_29) {
    "use strict";
    var __moduleName = context_29 && context_29.id;
    var TrackableCollection, TrackState;
    return {
        setters: [
            function (TrackableCollection_1) {
                TrackableCollection = TrackableCollection_1;
            },
            function (TrackState_2) {
                TrackState = TrackState_2;
            }
        ],
        execute: function () {
            exports_29("TrackableCollection", TrackableCollection);
            exports_29("TrackState", TrackState);
        }
    };
});
System.register("Nep6/nep6wallet", ["../ThinNeo"], function (exports_30, context_30) {
    "use strict";
    var __moduleName = context_30 && context_30.id;
    var ThinNeo, contract, nep6account, nep6ScryptParameters, nep6wallet;
    return {
        setters: [
            function (ThinNeo_1) {
                ThinNeo = ThinNeo_1;
        ...
        execute: function () {
            ...
            exports_30("contract", contract);
            nep6account = (function () {
            ...
            exports_30("nep6account", nep6account);
            nep6ScryptParameters = (function () {
                function nep6ScryptParameters() {
                }
                return nep6ScryptParameters;
            }());
            exports_30("nep6ScryptParameters", nep6ScryptParameters);
            nep6wallet = (function () {
                function nep6wallet() {
                }
            ...
            exports_30("nep6wallet", nep6wallet);
        }
    };
});
System.register("ThinNeo/Base64", [], function (exports_31, context_31) {
    "use strict";
    ...
    exports_31("toByteArray", toByteArray);
    function tripletToBas64(num) {
    ...
    function encodeChunk(uint8, start, end) {
        ...
        for (var i = start; i < end; i += 3) {
            ...
            output.push(tripletToBas64(tmp));
        }
        return output.join('');
    }
    ...
    exports_31("fromByteArray", fromByteArray);
    var lookup, revLookup, code, binited;
    return {
        setters: [],
        execute: function () {
            lookup = [];
...
System.register("ThinNeo/helper", ["crypto-js", "buffer", "../Neo", "ThinNeo/Base64"], function (exports_32, context_32) {
    "use strict";
    ...
    exports_32("GetPrivateKeyFromWIF", GetPrivateKeyFromWIF);
    function GetWifFromPrivateKey(prikey) {
    ...
    exports_32("GetWifFromPrivateKey", GetWifFromPrivateKey);
    ...
    exports_32("GetPublicKeyFromPrivateKey", GetPublicKeyFromPrivateKey);
    function Hash160(data) {
        var hash1 = Neo.Cryptography.Sha256.computeHash(data);
        var hash2 = Neo.Cryptography.RIPEMD160.computeHash(hash1);
        return new Uint8Array(hash2);
    }
    exports_32("Hash160", Hash160);
    function GetAddressCheckScriptFromPublicKey(publicKey) {
    ...
    exports_32("GetAddressCheckScriptFromPublicKey", GetAddressCheckScriptFromPublicKey);
    function GetPublicKeyScriptHashFromPublicKey(publicKey) {
    ...
    exports_32("GetPublicKeyScriptHashFromPublicKey", GetPublicKeyScriptHashFromPublicKey);
    function GetScriptHashFromScript(script) {
        var scripthash = Neo.Cryptography.Sha256.computeHash(script);
        scripthash = Neo.Cryptography.RIPEMD160.computeHash(scripthash);
        return new Uint8Array(scripthash);
    }
    exports_32("GetScriptHashFromScript", GetScriptHashFromScript);
    ...
    exports_32("GetAddressFromScriptHash", GetAddressFromScriptHash);
    function GetAddressFromPublicKey(publicKey) {
        var scripthash = GetPublicKeyScriptHashFromPublicKey(publicKey);
        return GetAddressFromScriptHash(scripthash);
    }
    exports_32("GetAddressFromPublicKey", GetAddressFromPublicKey);
    function GetPublicKeyScriptHash_FromAddress(address) {
    ...
    exports_32("GetPublicKeyScriptHash_FromAddress", GetPublicKeyScriptHash_FromAddress);
    ...
    exports_32("VerifySignature", VerifySignature);
    ...
    exports_32("String2Bytes", String2Bytes);
    ...
    exports_32("Bytes2String", Bytes2String);
    function Aes256Encrypt(src, key) {
    ...
    exports_32("Aes256Encrypt", Aes256Encrypt);
    function Aes256Encrypt_u8(src, key) {
    ...
    exports_32("Aes256Encrypt_u8", Aes256Encrypt_u8);
    function Aes256Decrypt_u8(encryptedkey, key) {
        var keys = CryptoJS.enc.Utf8.parse("1234123412341234");
        keys.sigBytes = key.length;
        keys.words = new Array(key.length / 4);
        for (var i = 0; i < key.length / 4; i++) {
        ...
        var base64key = Base64_1.fromByteArray(encryptedkey);
    ...
    exports_32("Aes256Decrypt_u8", Aes256Decrypt_u8);
    function GetNep2FromPrivateKey(prikey, passphrase, n, r, p, callback) {
        if (n === void 0) { n = 14; }
        if (r === void 0) { r = 8; }
        if (p === void 0) { p = 8; }
        var pubkey = GetPublicKeyFromPrivateKey(prikey);
        var addr = GetAddressFromPublicKey(pubkey);
    ...
    exports_32("GetNep2FromPrivateKey", GetNep2FromPrivateKey);
    function GetPrivateKeyFromNep2(nep2, passphrase, n, r, p, callback) {
        if (n === void 0) { n = 14; }
        if (r === void 0) { r = 8; }
        if (p === void 0) { p = 8; }
    ...
    exports_32("GetPrivateKeyFromNep2", GetPrivateKeyFromNep2);
    ...
    exports_32("GetAddrHash", GetAddrHash);
    var CryptoJS, Buffer, Neo, Base64_1, scrypt_loaded;
    return {
        setters: [
            function (CryptoJS_1) {
                CryptoJS = CryptoJS_1;
...
System.register("ThinNeo/opcode", [], function (exports_33, context_33) {
    "use strict";
...
System.register("ThinNeo/ScriptBuilder", ["ThinNeo/helper", "ThinNeo/opcode", "../Neo"], function (exports_34, context_34) {
    "use strict";
    var __moduleName = context_34 && context_34.id;
    var helper_1, opcode_1, Neo, ScriptBuilder;
    return {
        setters: [
            function (helper_1_1) {
                helper_1 = helper_1_1;
        ...
        execute: function () {
            ScriptBuilder = (function () {
                ...
                ScriptBuilder.prototype.EmitPushString = function (data) {
                    return this.EmitPushBytes(helper_1.String2Bytes(data));
                };
                ScriptBuilder.prototype.EmitSysCall = function (api) {
                    if (api == null)
                        throw new Error("ArgumentNullException");
                    var api_bytes = helper_1.String2Bytes(api);
                ...
                ScriptBuilder.prototype.EmitParamJson = function (param) {
                    if (typeof param === "number") {
                        ...
                        this.Emit(opcode_1.OpCode.PACK);
                    }
                        ...
                        if (str.indexOf("(str)") == 0) {
                            ...
                            var hex = helper_1.GetPublicKeyScriptHash_FromAddress(addr);
                            this.EmitPushBytes(hex);
                        }
            ...
            exports_34("ScriptBuilder", ScriptBuilder);
        }
    };
});
System.register("ThinNeo/TransAction", ["ThinNeo/helper", "ThinNeo/ScriptBuilder", "../Neo"], function (exports_35, context_35) {
    "use strict";
    var __moduleName = context_35 && context_35.id;
    var helper_2, ScriptBuilder_1, Neo, TransactionType, TransactionAttributeUsage, Attribute, TransactionOutput, TransactionInput, Witness, InvokeTransData, ClaimTransData, MinerTransData, Transaction;
    return {
        setters: [
            function (helper_2_1) {
                helper_2 = helper_2_1;
            },
            function (ScriptBuilder_1_1) {
                ScriptBuilder_1 = ScriptBuilder_1_1;
            },
            function (Neo_3) {
                Neo = Neo_3;
            }
        ...
        execute: function () {
            ...
            exports_35("TransactionType", TransactionType);
            ...
            exports_35("TransactionAttributeUsage", TransactionAttributeUsage);
            Attribute = (function () {
                function Attribute() {
                }
                return Attribute;
            }());
            exports_35("Attribute", Attribute);
            TransactionOutput = (function () {
                function TransactionOutput() {
                }
                return TransactionOutput;
            }());
            exports_35("TransactionOutput", TransactionOutput);
            TransactionInput = (function () {
                function TransactionInput() {
                }
                return TransactionInput;
            }());
            exports_35("TransactionInput", TransactionInput);
            Witness = (function () {
                function Witness() {
                }
                Object.defineProperty(Witness.prototype, "Address", {
                    get: function () {
                        var hash = helper_2.GetScriptHashFromScript(this.VerificationScript);
                        return helper_2.GetAddressFromScriptHash(hash);
                    },
                    enumerable: true,
                    configurable: true
                });
            ...
            exports_35("Witness", Witness);
            InvokeTransData = (function () {
            ...
            exports_35("InvokeTransData", InvokeTransData);
            ClaimTransData = (function () {
            ...
            exports_35("ClaimTransData", ClaimTransData);
            MinerTransData = (function () {
            ...
            exports_35("MinerTransData", MinerTransData);
            Transaction = (function () {
                ...
                Transaction.prototype.AddWitness = function (signdata, pubkey, addrs) {
                    {
                        ...
                        var bsign = helper_2.VerifySignature(msg, signdata, pubkey);
                        if (bsign == false)
                            throw new Error("wrong sign");
                        var addr = helper_2.GetAddressFromPublicKey(pubkey);
                        if (addr != addrs)
                            throw new Error("wrong script");
                    }
                    var vscript = helper_2.GetAddressCheckScriptFromPublicKey(pubkey);
                ...
                Transaction.prototype.AddWitnessScript = function (vscript, iscript) {
                    var scripthash = helper_2.GetScriptHashFromScript(vscript);
            ...
            exports_35("Transaction", Transaction);
        }
    };
});
System.register("ThinNeo/index", ["./avm2asm", "ThinNeo/helper", "ThinNeo/Base64", "ThinNeo/opcode", "ThinNeo/ScriptBuilder", "ThinNeo/TransAction"], function (exports_36, context_36) {
    "use strict";
    ...
    return {
        setters: [
            ...
            function (Helper_1) {
                Helper = Helper_1;
                exportStar_4(Helper_1);
            },
            function (Base64_2_1) {
                exportStar_4(Base64_2_1);
            },
            function (opcode_2_1) {
                exportStar_4(opcode_2_1);
            },
            function (ScriptBuilder_2_1) {
                exportStar_4(ScriptBuilder_2_1);
            },
            function (TransAction_1_1) {
                exportStar_4(TransAction_1_1);
            }
        ],
        execute: function () {
            exports_36("avm2asm", avm2asm);
            exports_36("Helper", Helper);
        }
    };
});
System.register("ThinNeo/avm2asm/op", ["ThinNeo/opcode"], function (exports_37, context_37) {
    "use strict";
    var __moduleName = context_37 && context_37.id;
    var opcode_3, ParamType, Op;
    return {
        setters: [
            function (opcode_3_1) {
                opcode_3 = opcode_3_1;
        ...
        execute: function () {
            ...
            exports_37("ParamType", ParamType);
            Op = (function () {
                function Op() {
                }
                ...
                Op.prototype.getCodeName = function () {
                    ...
                    if (this.error)
                        name = "[E]";
                    if (this.code == opcode_3.OpCode.PUSHT)
                        return "PUSH1(true)";
                    if (this.code == opcode_3.OpCode.PUSHF)
                        return "PUSH0(false)";
                    if (this.code > opcode_3.OpCode.PUSHBYTES1 && this.code < opcode_3.OpCode.PUSHBYTES75)
                        return name + "PUSHBYTES" + (this.code - opcode_3.OpCode.PUSHBYTES1 + 1);
                    else
                        return name + opcode_3.OpCode[this.code].toString();
                };
                return Op;
            }());
            exports_37("Op", Op);
...
System.register("ThinNeo/avm2asm/byteReader", [], function (exports_38, context_38) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_38("ByteReader", ByteReader);
            exports_38("default", ByteReader);
        }
    };
});
System.register("ThinNeo/avm2asm/avm2asm", ["ThinNeo/opcode", "ThinNeo/avm2asm/op", "ThinNeo/avm2asm/byteReader"], function (exports_39, context_39) {
    "use strict";
    var __moduleName = context_39 && context_39.id;
    var opcode_4, op_1, byteReader_1, Avm2Asm;
    return {
        setters: [
            function (opcode_4_1) {
                opcode_4 = opcode_4_1;
            ...
            function (byteReader_1_1) {
                byteReader_1 = byteReader_1_1;
            }
        ],
        execute: function () {
            Avm2Asm = (function () {
                ...
                Avm2Asm.Trans = function (script) {
                    ...
                    while (breader.End == false) {
                        ...
                        try {
                            if (o.code >= opcode_4.OpCode.PUSHBYTES1 && o.code <= opcode_4.OpCode.PUSHBYTES75) {
                                ...
                                switch (o.code) {
                                    case opcode_4.OpCode.PUSH0:
                                    case opcode_4.OpCode.PUSHM1:
                                    case opcode_4.OpCode.PUSH1:
                                    case opcode_4.OpCode.PUSH2:
                                    case opcode_4.OpCode.PUSH3:
                                    case opcode_4.OpCode.PUSH4:
                                    case opcode_4.OpCode.PUSH5:
                                    case opcode_4.OpCode.PUSH6:
                                    case opcode_4.OpCode.PUSH7:
                                    case opcode_4.OpCode.PUSH8:
                                    case opcode_4.OpCode.PUSH9:
                                    case opcode_4.OpCode.PUSH10:
                                    case opcode_4.OpCode.PUSH11:
                                    case opcode_4.OpCode.PUSH12:
                                    case opcode_4.OpCode.PUSH13:
                                    case opcode_4.OpCode.PUSH14:
                                    case opcode_4.OpCode.PUSH15:
                                    case opcode_4.OpCode.PUSH16:
                                        o.paramType = op_1.ParamType.None;
                                        break;
                                    case opcode_4.OpCode.PUSHDATA1:
                                        {
                                            o.paramType = op_1.ParamType.ByteArray;
                                        ...
                                        break;
                                    case opcode_4.OpCode.PUSHDATA2:
                                        {
                                            o.paramType = op_1.ParamType.ByteArray;
                                        ...
                                        break;
                                    case opcode_4.OpCode.PUSHDATA4:
                                        {
                                            o.paramType = op_1.ParamType.ByteArray;
                                        ...
                                        break;
                                    case opcode_4.OpCode.NOP:
                                        o.paramType = op_1.ParamType.None;
                                        break;
                                    case opcode_4.OpCode.JMP:
                                    case opcode_4.OpCode.JMPIF:
                                    case opcode_4.OpCode.JMPIFNOT:
                                        o.paramType = op_1.ParamType.Addr;
                                        o.paramData = breader.ReadBytes(2);
                                        break;
                                    case opcode_4.OpCode.CALL:
                                        o.paramType = op_1.ParamType.Addr;
                                        o.paramData = breader.ReadBytes(2);
                                        break;
                                    case opcode_4.OpCode.RET:
                                        o.paramType = op_1.ParamType.None;
                                        break;
                                    case opcode_4.OpCode.APPCALL:
                                    case opcode_4.OpCode.TAILCALL:
                                        o.paramType = op_1.ParamType.ByteArray;
                                        o.paramData = breader.ReadBytes(20);
                                        break;
                                    case opcode_4.OpCode.SYSCALL:
                                        o.paramType = op_1.ParamType.String;
                                        o.paramData = breader.ReadVarBytes();
                                        break;
                                    case opcode_4.OpCode.DUPFROMALTSTACK:
                                    case opcode_4.OpCode.TOALTSTACK:
                                    case opcode_4.OpCode.FROMALTSTACK:
                                    case opcode_4.OpCode.XDROP:
                                    case opcode_4.OpCode.XSWAP:
                                    case opcode_4.OpCode.XTUCK:
                                    case opcode_4.OpCode.DEPTH:
                                    case opcode_4.OpCode.DROP:
                                    case opcode_4.OpCode.DUP:
                                    case opcode_4.OpCode.NIP:
                                    case opcode_4.OpCode.OVER:
                                    case opcode_4.OpCode.PICK:
                                    case opcode_4.OpCode.ROLL:
                                    case opcode_4.OpCode.ROT:
                                    case opcode_4.OpCode.SWAP:
                                    case opcode_4.OpCode.TUCK:
                                        o.paramType = op_1.ParamType.None;
                                        break;
                                    case opcode_4.OpCode.CAT:
                                    case opcode_4.OpCode.SUBSTR:
                                    case opcode_4.OpCode.LEFT:
                                    case opcode_4.OpCode.RIGHT:
                                    case opcode_4.OpCode.SIZE:
                                        o.paramType = op_1.ParamType.None;
                                        break;
                                    case opcode_4.OpCode.INVERT:
                                    case opcode_4.OpCode.AND:
                                    case opcode_4.OpCode.OR:
                                    case opcode_4.OpCode.XOR:
                                    case opcode_4.OpCode.EQUAL:
                                        o.paramType = op_1.ParamType.None;
                                        break;
                                    case opcode_4.OpCode.INC:
                                    case opcode_4.OpCode.DEC:
                                    case opcode_4.OpCode.SIGN:
                                    case opcode_4.OpCode.NEGATE:
                                    case opcode_4.OpCode.ABS:
                                    case opcode_4.OpCode.NOT:
                                    case opcode_4.OpCode.NZ:
                                    case opcode_4.OpCode.ADD:
                                    case opcode_4.OpCode.SUB:
                                    case opcode_4.OpCode.MUL:
                                    case opcode_4.OpCode.DIV:
                                    case opcode_4.OpCode.MOD:
                                    case opcode_4.OpCode.SHL:
                                    case opcode_4.OpCode.SHR:
                                    case opcode_4.OpCode.BOOLAND:
                                    case opcode_4.OpCode.BOOLOR:
                                    case opcode_4.OpCode.NUMEQUAL:
                                    case opcode_4.OpCode.NUMNOTEQUAL:
                                    case opcode_4.OpCode.LT:
                                    case opcode_4.OpCode.GT:
                                    case opcode_4.OpCode.LTE:
                                    case opcode_4.OpCode.GTE:
                                    case opcode_4.OpCode.MIN:
                                    case opcode_4.OpCode.MAX:
                                    case opcode_4.OpCode.WITHIN:
                                        o.paramType = op_1.ParamType.None;
                                        break;
                                    case opcode_4.OpCode.SHA1:
                                    case opcode_4.OpCode.SHA256:
                                    case opcode_4.OpCode.HASH160:
                                    case opcode_4.OpCode.HASH256:
                                    case opcode_4.OpCode.CSHARPSTRHASH32:
                                    case opcode_4.OpCode.JAVAHASH32:
                                    case opcode_4.OpCode.CHECKSIG:
                                    case opcode_4.OpCode.CHECKMULTISIG:
                                        o.paramType = op_1.ParamType.None;
                                        break;
                                    case opcode_4.OpCode.ARRAYSIZE:
                                    case opcode_4.OpCode.PACK:
                                    case opcode_4.OpCode.UNPACK:
                                    case opcode_4.OpCode.PICKITEM:
                                    case opcode_4.OpCode.SETITEM:
                                    case opcode_4.OpCode.NEWARRAY:
                                    case opcode_4.OpCode.NEWSTRUCT:
                                        o.paramType = op_1.ParamType.None;
                                        break;
                                    case opcode_4.OpCode.THROW:
                                    case opcode_4.OpCode.THROWIFNOT:
                                        o.paramType = op_1.ParamType.None;
                                        break;
                                    default:
            ...
            exports_39("Avm2Asm", Avm2Asm);
        }
    };
});
System.register("ThinNeo/avm2asm/index", ["ThinNeo/avm2asm/avm2asm"], function (exports_40, context_40) {
    "use strict";
    ...
    return {
        setters: [
            function (avm2asm_2_1) {
                exportStar_5(avm2asm_2_1);
            }
        ],
        execute: function () {
        }
